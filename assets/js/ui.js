...
/* ---------------- icons ----------------
   Professional stroke icon set — 24×24 grid, 1.6–1.8px strokes,
   round caps, currentColor. Brand logos keep their original color shapes. */
const P = {
  search: '<circle cx="10" cy="10" r="6"/><path d="M10 16 L10 19.5 M6.8 19.5 L18.5 19.5"/>',
  cart: '<path d="M5 9 L19 9 L19 18.5 L5 18.5 Z"/><path d="M14 4.5 L14 9 M10.5 4.2 L17.5 4.2"/><circle cx="8" cy="20" r="1.8"/><circle cx="16" cy="20" r="1.8"/>',
  'shopping-bag': '<path d="M6 8 L18 8 L18 19 L6 19 Z"/><path d="M10.5 3.5 L10.5 8 M13.5 3.5 L13.5 8 M10.5 3.5 L13.5 3.5"/>',
  store: '<path d="M4 5 L20 5 M4 5 L4 9 M20 5 L20 9 M7 5 L7 9 M13 5 L13 9 M19 5 L19 9"/><path d="M4 13 L20 13 L20 17 L4 17 Z"/><circle cx="9.5" cy="15" r="0.9"/>',
  box: '<path d="M4 5 L20 5 L20 20 L4 20 Z"/><path d="M8 5 L8 20 M16 5 L16 20 M8 5 L16 5"/><path d="M10 12.5 L14.5 12.5 L14.5 15.5 L10 15.5 Z"/>',
  sparkles: '<path d="M12 3 L12 21 M3 12 L21 12"/><path d="M12 7.5 L12 16.5 M7.5 12 L16.5 12"/>',
  chat: '<path d="M3.5 5 L20.5 5 L20.5 18.5 L3.5 18.5 Z"/><path d="M5 19.5 L5 15.5 L11 19.5 Z"/><circle cx="9" cy="10" r="1.05" fill="currentColor" stroke="none"/><circle cx="13" cy="10" r="1.05" fill="currentColor" stroke="none"/><circle cx="17" cy="10" r="1.05" fill="currentColor" stroke="none"/>',
  user: '<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>',
  settings: '<circle cx="12" cy="12" r="5"/><rect x="11" y="2.5" width="2" height="3" rx="0.6"/><rect x="11" y="18.5" width="2" height="3" rx="0.6"/><rect x="2.5" y="11" width="3" height="2" rx="0.6"/><rect x="18.5" y="11" width="3" height="2" rx="0.6"/><rect x="13.8" y="4" width="2" height="3" rx="0.6"/><rect x="8.2" y="17" width="2" height="3" rx="0.6"/><rect x="4.2" y="8" width="2" height="3" rx="0.6"/><rect x="17.8" y="13" width="2" height="3" rx="0.6"/>',
  shield: '<path d="M12 3 L4.5 6.5 L19.5 6.5 L16.5 9.5 L13.5 20 L7.5 9.5 Z"/><path d="M9.5 15.5 L11 13.5 L13.5 15.8 L9.5 15.5 L15 10.5"/>',
  plus: '<path d="M12 5 L12 19 M5 12 L19 12"/>',
  minus: '<path d="M5 12 L19 12"/>',
  check: '<path d="M5.5 17.5 L10.5 12.5 L11.7 13.7 L18.5 6.5"/>',
  star: '<path d="M12 4.5 L14.1 10.1 L20.1 10.4 L15.4 14.1 L17 19.9 L12 16.6 L7 19.9 L8.6 14.1 L3.9 10.4 L9.9 10.1 Z"/>',
  ...
  menu: '<path d="M4.5 6.5 L19.5 6.5 M4.5 12 L19.5 12 M4.5 17.5 L19.5 17.5"/>',
  x: '<path d="M6.5 6.5 L17.5 17.5 M17.5 6.5 L6.5 17.5"/>',
  chev: '<path d="M6 12 L18 4.5 M6 12 L18 19.5"/>',
  chevd: '<path d="M5.5 7.5 L18.5 7.5 L12 18.5"/>',
  arrow: '<path d="M4.5 12 L15 12 M15 12 L20.5 6.5 L20.5 17.5"/>',
  image: '<rect x="3.5" y="4.5" width="17" height="15" rx="2.5"/><circle cx="7.5" cy="8.5" r="1.5"/><path d="M5.5 14.5 L11.5 11.5 L17.5 14.5 M11.5 11.5 L11.5 14.5 M8.5 8.5 L12 8.5"/>',
  video: '<rect x="4" y="5" width="16" height="14" rx="2.5"/><path d="M10.5 8.5 L10.5 15.5 L14 12 Z"/>',
  trash: '<path d="M5.5 7 L18.5 7 L18.5 19 L5.5 19 Z"/><path d="M5.5 4.5 L10 5.5 M18.5 4.5 L11 5.5 M5.5 4.5 L5.5 7 M18.5 4.5 L18.5 7"/><path d="M8.5 10.5 L15.5 10.5 M8.5 15.5 L15.5 15.5"/>',
  edit: '<rect x="8.5" y="1.5" width="7" height="3" rx="1"/><rect x="9" y="4.5" width="6" height="12.5" rx="1"/><path d="M9.5 17 L14.5 17 L12 21.5 Z"/><path d="M12 20.5 L12 21.5"/>',
  ...
  trend: '<path d="M4 17 L9 12.5 L13 13.5 L16 9 L21 4.5"/><path d="M21 3 L21 8"/>',
  ...
  copy: '<rect x="3.5" y="3.5" width="7.5" height="7.5" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="7.5" rx="1.5"/><rect x="6.5" y="13.5" width="10" height="7" rx="1.5"/>',
  sun: '<circle cx="12" cy="12" r="4.5"/><path d="M12 3 L12 5.5 M19.5 12 L21.5 12 M12 18.5 L12 21 M4.5 12 L2.5 12 M16.8 7.2 L19.4 4.6 M16.8 16.8 L19.4 19.4 M7.2 16.8 L4.6 19.4 M7.2 7.2 L4.6 4.6"/>',
  moon: '<path d="M21 12.8A8.8 8.8 0 0 1 11.2 3a9 9 0 1 0 9.8 9.8Z"/>',
  clock: '<circle cx="12" cy="12" r="8.5"/><path d="M12 12 L12 6 M12 12 L16.8 12 M11 12 L9.5 17"/>',
  ...
  download: '<path d="M12 4.5 L12 14.5 M8 9.5 L12 6.5 M16 9.5 L12 6.5 M5.5 20 L18.5 20"/>',
  upload: '<path d="M12 19.5 L12 9.5 M8 14.5 L12 17.5 M16 14.5 L12 17.5 M5.5 4 L18.5 4"/>',
  send: '<path d="m4 12 16-8-6 16-2.5-6Z"/>',
  info: '<circle cx="12" cy="12" r="8.6"/><path d="M12 12 L12 18.6"/><circle cx="12" cy="7.5" r="1.2" fill="currentColor" stroke="none"/>',
  warning: '<path d="M12 3.5 L8.5 7.5 L15.5 7.5 L15.5 18.5 L8.5 18.5 Z"/><path d="M12 11 L12 16.5"/><circle cx="12" cy="7" r="1.1" fill="currentColor" stroke="none"/>',
  ...
  pin: '<path d="M12 3 L12 14 M12 14 a2.4 2.4 0 1 1 -2.4-2.4 L9.6 16.4 L9.6 20.2 Z"/>',
  mail: '<rect x="3" y="4" width="18" height="10" rx="2"/><path d="M3 14 L21 14 L3 18.5 L21 18.5"/><path d="M10.5 8 L13.5 8"/>',
  phone: '<path d="M7 6 L17 6 L17 18.5 L7 18.5 Z"/><path d="M9.5 10.5 L14.5 10.5 M9.5 15.5 L14.5 15.5"/>',
  location: '<path d="M12 3.5 L12 11 L12 11 L3.5 15 L20.5 15 L3.5 19 L20.5 19 Z"/><path d="M12 11 L17.5 8.5 M8 11 L3.5 8.5"/>',
  dashboard: '<rect x="4" y="4" width="7" height="5" rx="1"/><rect x="13.5" y="4" width="6.5" height="5" rx="1"/><rect x="4" y="11.5" width="16.5" height="8" rx="1"/><path d="M6.5 16.5 L9 20.5 M12.5 13.5 L19.5 18.5"/>',
  chart: '<path d="M4 8 L8 6 L12 10 L16 5 L20 9"/><path d="M4 19 L20 19 M5.5 12.5 L7 4 M18 12.5 L18.5 18"/>',
  team: '<circle cx="8" cy="9" r="4.6"/><circle cx="16" cy="9" r="4.6"/><circle cx="12" cy="17.5" r="4.6"/>',
  award: '<path d="M7.5 4 L16.5 4 L16.5 8 L7.5 8 Z"/><path d="M12 8 L12 15 L13.5 13.5 L10.5 13.5 M10.5 13.5 L10.5 12.5 M13.5 13.5 L13.5 12.5 Z"/>',
  'truck-fast': '<path d="M4 8 L20 8 L20 12 L4 12 Z"/><path d="M18.5 8 L21.5 5.5 L21.5 14.5 L18.5 18.5"/>',
}

export function icon(name, cls = '', size = 20) {
  const d = P[name] || P.info
  const filled = name === 'star' && cls.includes('fill')
  return `<svg class="ic ${cls}" width="${size}" height="${size}" viewBox="0 0 24 24" fill="${filled ? 'currentColor' : 'none'}" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${d}</svg>`
}
